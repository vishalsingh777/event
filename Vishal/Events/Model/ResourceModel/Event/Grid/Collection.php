...
/**
 * Grid/Collection.php
 * Path: app/code/Vishal/Events/Model/ResourceModel/Event/Grid/Collection.php
 */

declare(strict_types=1);

namespace Vishal\Events\Model\ResourceModel\Event\Grid;
...
use Vishal\Events\Model\ResourceModel\Event\Collection as EventCollection;
...
class Collection extends EventCollection implements SearchResultInterface
{
    ...
    /**
     * Prepare the store column to display all store views where event is available
     *
     * @return void
     */
