<?php
namespace Insead\Events\Ui\Component\Form\Modifier;
...
class TimeSlots implements ModifierInterface
{
    ...
    public function modifyMeta(array $meta)
    {
        if (isset($meta['time_slots_fieldset']['children']['time_slots_selection']['children']['time_slots_grid'])) {
            ...
            $meta['time_slots_fieldset']['children']['time_slots_selection']['children']['time_slots_grid']['arguments']['data']['config']['template'] = 'Insead_Events/form/field/time-slots';
        }
